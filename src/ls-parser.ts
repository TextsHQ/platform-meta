...
export const IGNORED_CALLS = new Set([
  ...
  'insertSearchSection',
  'issueNewTask',
  'lazyThreadForcedFetch',
  'mailboxTaskCompletionApiOnTaskCompletion',
  'markThreadRead',
  'mciTraceLog',
  'moveThreadToE2EECutoverFolder',
  ...
  'updateOccamadilloMostRecentMessagePerThread',
  'updateOngoingCallServerInfoData',
  'updateOptimisticEphemeralMediaState',
  'updateOrInsertReactionV2',
  'updateOrInsertRtcOngoingCallData',
